...
return [
     ...
     */
    'routes' => [
        'AxisubsAppTaxes' => __DIR__ . '/app/routes.php'
    ],
     ...
     */
    'panels' => [
        'AxisubsAppTaxes' => __DIR__ . '/app/panels.php'
    ],
     ...
     */
    'apis' => [
        'AxisubsAppTaxes' => __DIR__ . '/app/api.php'
    ],

    /**
     * The view paths to register.
     *
     * E.G: 'AxisubsAppTaxes' => __DIR__ . '/views'
     * can be referenced via @AxisubsAppTaxes/
     * when rendering a view in twig.
     */
    'views' => [
        'AxisubsAppTaxes' => __DIR__ . '/resources/views'
    ],
